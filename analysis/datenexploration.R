...
# 2.5.1 Geschlechterverteilung ansehen
# * Wie viele Maenner und Frauen sind im Datensatz?
student_data_cleaned %>%
  count(sex)

# 2.5.2 Mittelwert und Spannweite des Alters
...
# 2.5.5 Zusammenhang Noten und Familiengröße
...
# 2.6.1 Balkendiagramm  zu familiären Bindungen und Geschlecht
...
# 2.6.3 Balkendiagramm Bildungslevel Mütter
...
# 2.6.4 Visualisierung speichern
# Speichere die Visualisierung im R-Projekt ab unter dem Pfad
# images/barbplot_mothers_education_status.png
